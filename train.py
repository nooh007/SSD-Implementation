...
def validate(valid_data_loader, model):
    ...
    for i, data in enumerate(prog_bar):
        ...
        # Debugging: Check the targets and predictions for each image
        for i in range(len(images)):
            print(f"Debugging for Image {i}:")
            print("True Labels:", targets[i]['labels'])
            print("Predicted Labels:", outputs[i]['labels'])
            print("True Boxes:", targets[i]['boxes'])
            print("Predicted Boxes:", outputs[i]['boxes'])
